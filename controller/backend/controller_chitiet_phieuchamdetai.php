		...
		public function __construct(){
			...
			switch($act){
				...
				case "xem":
					...
					$form_action = "admin.php?controller=chitiet_phieuchamdetai&act=xem&id=$id";
					//load view
					include "view/backend/view_chitiet_phieuchamdetai.php";
				break;
				default:
					//di chuyen den trang 
					header("location:admin.php?controller=phieuchamdetai");
				break;
				//----
			}
		}
