		...
		public function __construct(){
			...
			switch($act){
				...
				case "xem":
					...
					$form_action = "hoidong.php?controller=chitiet_detaibihuy&act=xem&id=$id";
					//load view
					include "view/backend/w_hoidong/view_chitiet_detaibihuy.php";
				break;
				default:
					//di chuyen den trang 
					header("location:hoidong.php?controller=detaibihuy");
				break;
				//----
			}
		}
