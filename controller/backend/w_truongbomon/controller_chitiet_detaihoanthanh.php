		...
		public function __construct(){
			...
			switch($act){
				...
				case "xem":
					...
					$form_action = "truongbomon.php?controller=chitiet_detaihoanthanh&act=xem&id=$id";
					//load view
					include "view/backend/w_truongbomon/view_chitiet_detaihoanthanh.php";
				break;
				default:
					//di chuyen den trang 
					header("location:truongbomon.php?controller=detaihoanthanh");
				break;
				//----
			}
		}
