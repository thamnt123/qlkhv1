    ...
    <div class="page-title">
      ...
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          <div class="x_title">
            <div>
				<a href="admin.php?controller=add_edit_thongtinhoidong&act=add" class="btn btn-primary">Add</a>
			</div>
            <div class="clearfix"></div>
          </div>
              ...
              <table class="table table-striped jambo_table bulk_action">
                ...
                <?php foreach($arr as $rows): ?>
                  <tr class="even pointer">
                    ...
                    <td class=" last">
                    	<a href="admin.php?controller=add_edit_thongtinhoidong&act=edit&id=<?php echo $rows->pk_hoidong_id; ?>">Edit</a>&nbsp;&nbsp;
						          <a onclick="return window.confirm('Are you sure?');" href="admin.php?controller=add_edit_thongtinhoidong&act=delete&id=<?php echo $rows->pk_hoidong_id; ?>">Delete</a>
                    </td>
                  </tr>
                <?php endforeach; ?>
                </tbody>
        ...
        <div class="col-md-offset">
          <button class="btn btn-primary" type="button"><a href="admin.php?controller=hoidong" style="color: white;">Cancel</a></button>
