              ...
              <table class="table table-striped jambo_table bulk_action">
                ...
                <?php foreach($arr as $rows): ?>
                  <tr class="even pointer">
                    ...
                    <td class=" " style="width: 150px;"><?php echo ucfirst($rows->c_tendetai); ?></td>
                    <td class=" ">
                      <?php 
                    ...
                    <td class=" last">
                      <a href="truongbomon.php?controller=detaichoxetduyet&<?php echo "act=duyet&id=".$rows->pk_madetai_id ?>">
                          <button  type="button" class="btn btn-default btn-xs btn-duyet">Duyệt</button>
                      </a>
                      <a href="truongbomon.php?controller=detaichoxetduyet&<?php echo "act=huy&id=".$rows->pk_madetai_id ?>">
                          <button  type="button" class="btn btn-default btn-xs btn-duyet">Hủy</button>
                      </a>
                      <button type="button" class="btn btn-default btn-xs"><a href="truongbomon.php?controller=chitiet_detaichoxetduyet&act=xem&id=<?php echo $rows->pk_madetai_id; ?>"">Xem chi tiết</a></button>
                    </td>
              ...
              <!-- phân trang -->
	          	<div class="card-footer" style="padding:5px !important">
					...
					<?php for($i=1; $i<=$num_page; $i++): ?>	
						<li class="page-item"><a class="page-link" href="truongbomon.php?controller=detaichoxetduyet&p=<?php echo $i; ?>"><?php echo $i; ?></a></li>
					<?php endfor; ?>
					</ul>
				</div>
			<!-- end phân trang -->
