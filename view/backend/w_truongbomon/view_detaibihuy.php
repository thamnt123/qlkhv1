                ...
                <?php foreach($arr as $rows): ?>
                  <tr class="even pointer">
                   ...
                   <!--  <td class=" "><?php echo $rows->c_kinhphi; ?></td> -->
                    ...
                    <td class=" last">
                      <button type="button" class="btn btn-default btn-xs"><a href="truongbomon.php?controller=chitiet_detaibihuy&act=xem&id=<?php echo $rows->pk_madetai_id; ?>"">Xem chi tiết</a></button>
                    </td>
