              ...
              <table class="table table-striped jambo_table bulk_action">
                ...
                <?php foreach($arr as $rows): ?>
                  <tr class="even pointer">
                    ...
                    <td class=" last">
                      <button type="button" class="btn btn-default btn-xs"><a id="btn_xemchitiet" onclick="xemChiTiet().call(this);" href="admin.php?controller=chitiet_detaibihuy&act=xem&id=<?=$rows->pk_madetai_id?>">Xem chi tiết</a></button>                   
                    </td>
