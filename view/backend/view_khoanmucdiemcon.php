    ...
    <div class="page-title">
      ...
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          <div class="x_title">
            <div>
				<a href="admin.php?controller=add_edit_khoanmucdiemcon&act=add" class="btn btn-primary">Add</a>
			</div>
            <div class="clearfix"></div>
          </div>
                ...
                <tbody>
                  ...
                  <tr class="even pointer">
                    ...
                    <td class=" last">
						...
						<a onclick="return window.confirm('Are you sure?');" href="admin.php?controller=add_edit_khoanmucdiemcon&act=delete&id=<?php echo $rows->pk_khoanmucdiem_id; ?>">Delete</a>
                    </td>
                  </tr>
                  <?php endforeach; ?>
