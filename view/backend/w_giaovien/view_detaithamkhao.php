      ...
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            ...
            ?>  
                    ...
                    <td class=" "><button type="button" class="btn btn-info btn-xs"><a href="<?php echo $rows->file_mo_ta; ?>" style="color: white;">Download</a></button></td>
                     ...
                     <td class=" last">
                      ...
                      <button type="button" class="btn btn-default btn-xs"><a href="giaovien.php?controller=chitiet_detaithamkhao&act=xem&id=<?php echo $rows->pk_madetai_id; ?>"">Xem chi tiết</a></button>
                    </td>
          ...
          <?php for($i=1; $i<=$num_page; $i++): ?>  
            <li class="page-item"><a class="page-link" href="giaovien.php?controller=detaithamkhao&p=<?php echo $i; ?>"><?php echo $i; ?></a></li>
          <?php endfor; ?>
          </ul>
        </div>
      <!-- end phân trang -->
