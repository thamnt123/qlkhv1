  ...
  <div class="">
    <div class="page-title">
      <div class="title_left">
        <h3>Danh sách đề tài hoàn thành đúng thời hạn</h3>
      </div>
      ...
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
              ...
              <table class="table table-striped jambo_table bulk_action">
                ...
                <?php foreach($arr as $rows): ?>
                  <tr class="even pointer">
                    ...
                    <td class=" last">
                      <button type="button" class="btn btn-default btn-xs"><a id="btn_xemchitiet" onclick="xemChiTiet().call(this);" href="admin.php?controller=chitiet_detaidunghan&act=xem&id=<?=$rows->pk_madetai_id?>">Xem chi tiết</a></button>                   
                    </td>
          ...
          <?php for($i=1; $i<=$num_page; $i++): ?>  
            <li class="page-item"><a class="page-link" onclick="phanTrang(this)" href="admin.php?controller=detaidunghan&p=<?php echo $i; ?>" ><?php echo $i; ?></a></li>
