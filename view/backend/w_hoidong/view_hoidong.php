                ...
                <?php foreach($arr as $rows): ?>
                  <tr  class="even pointer">
                    ...
                    <td class=" ">
                      ...
                      <a href="hoidong.php?controller=thongtinhoidong&IdHoiDong=<?=$rows->pk_hoidong_id?>&TenHoiDong=<?=$rows->c_tenhoidong?>&IdDeTai=<?=$rows->fk_madetai_id?>" style="color: white;">Thành viên hội đồng</a></button> 
                    </td>
