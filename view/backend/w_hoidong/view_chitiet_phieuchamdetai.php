              ...
              <table class="table table-striped jambo_table bulk_action">
                ...
                <?php foreach($arr as $rows): ?>
                  ...
                  <tr id="ptrId_<?=$rows1->pk_khoanmucdiem_id?>" parentTr="<?=$rows1->parentId?>" class="even pointer linePoint">
                    ...
                    <td class=" "><input parent="<?=$rows->pk_khoanmucdiem_id?>" type="text" class="form-control diem_chu_tich" value="<?=$rows->diem_chu_tich?>" readonly></td>
                    <td class=" "><input parent="<?=$rows->pk_khoanmucdiem_id?>" type="text" class="form-control diem_phan_bien_1" value="<?=$rows->diem_phan_bien_1?>" readonly></td>
                    <td class=" ">
                      <input parent="<?=$rows->pk_khoanmucdiem_id?>" type="text" class="form-control diem_phan_bien_2" value="<?=$rows->diem_phan_bien_2?>" readonly>
                    </td>
                  </tr>
                <?php endforeach; ?>
                <?php endforeach; ?>
                   ...
                   <div class="ln_solid"></div>
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-5">
                          <button class="btn btn-primary" type="button"><a href="hoidong.php?controller=phieuchamdetai" style="color: white;">Quay lại</a></button>
                        </div>
                      </div>
            </div>
