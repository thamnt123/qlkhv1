              ...
              <table class="table table-striped jambo_table bulk_action">
                ...
                <?php foreach($arr as $rows): ?>
                  <tr class="even pointer">
                    ...
                    <td class=" last">
                      <button type="button" class="btn btn-default btn-xs"><a href="hoidong.php?controller=chitiet_detaihoanthanh&act=xem&id=<?php echo $rows->pk_madetai_id; ?>"">Xem chi tiết</a></button>                   
                    </td>
              ...
              <!-- phân trang -->
	          	<div class="card-footer" style="padding:5px !important">
					...
					<?php for($i=1; $i<=$num_page; $i++): ?>	
						<li class="page-item"><a class="page-link" href="hoidong.php?controller=detaihoanthanh&p=<?php echo $i; ?>"><?php echo $i; ?></a></li>
					<?php endfor; ?>
					</ul>
				</div>
			<!-- end phân trang -->
