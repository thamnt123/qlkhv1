<?php 
	...
	//
	$ngay_hop = isset($_GET["ngayHop"])?$_GET["ngayHop"]:"01-01-2018";
	...
	// //echo print_r($_GET);
	 $model = new model();
	 $model->execute("INSERT INTO `tbl_detai_phieucham` (`fk_madetai_id`, `ghi_chu`, `y_kien`, `xep_loai`, `ngay_hop`, `dia_diem`, `detaidunghan_quahan`) VALUES ('{$fk_madetai_id}', '{$ghi_chu}', '{$y_kien}', '{$xep_loai}', '{$ngay_hop}', '{$dia_diem}', '{$detaidunghan_quahan}')");
